...
court_list['panzhihua'] = ['攀枝花市中级人民法院',
'攀枝花市东区人民法院',
'攀枝花市西区人民法院',
'攀枝花市仁和区人民法院',
'米易县人民法院',
...
court_list['guangyuan'] = ['广元市中级人民法院',
'广元市利州区人民法院',
'广元市昭化区人民法院',
'广元市朝天区人民法院',
'旺苍县人民法院',
...
court_list['ziyang'] = ['资阳市中级人民法院',
'资阳市雁江区人民法院',
'安岳县人民法院',
'乐至县人民法院',
'简阳市人民法院']

court_list['wenchuan'] = ['阿坝藏族羌族自治州中级人民法院',
'汶川县人民法院',
'理县人民法院',
'茂县人民法院',
'松潘县人民法院',
...
court_list['kangding'] = ['甘孜藏族自治州中级人民法院',
'康定市人民法院',
'康定县人民法院',
'泸定县人民法院',
'丹巴县人民法院',
...
court_list['xichang'] = ['凉山彝族自治州中级人民法院',
'西昌市人民法院',
'木里藏族自治县人民法院',
'盐源县人民法院',
'德昌县人民法院',
...
court_list['tielu'] = ['成都铁路运输中级法院',
'成都铁路运输法院',
'西昌铁路运输法院']

court_list_all = ['成都市锦江区人民法院', '成都市青羊区人民法院', '成都市金牛区人民法院', '成都市武侯区人民法院', '成都市成华区人民法院', '成都市龙泉驿区人民法院', '成都市青白江区人民法院',
                  '成都市温江区人民法院', '金堂县人民法院', '双流区人民法院', '郫县人民法院', '大邑县人民法院', '蒲江县人民法院', '新津县人民法院', '都江堰市人民法院', '彭州市人民法院',
...
D|达|邓|旦|多|丁|窦|党|豆|地|卞|当|杜|但|董|代|登|刁|段|戴|得|东|丹|\
E|额|耳|俄|\
F|傅|范|丰|房|扈|奉|俸|付|裴|冯|方|符|伏|樊|封|费|扶|凡|\
...
S|单|苏|寿|宿|山|厍|盛|色|松|粟|舒|石|申|首|双|师|税|佘|史|索|商|尚|孙|桑|施|司|四|赛|沈|邵|沙|宋|帅|什|三|\
T|谭|吐|屠|谈|塔|滕|腾|汤|土|田|唐|童|涂|凃|铁|陶|佟|图|\
W|万|枉|伟|文|汪|卫|乌|闻|魏|巫|危|伍|邬|温|武|韦|王|吴|宛|翁|旺|\
X|宣|项|萧|咸|奚|席|谢|辛|幸|先|旭|解|习|霞|鲜|邢|薛|修|宪|向|肖|夏|徐|许|熊|Ｘ|\
Y|于|伊|院|燕|阴|银|衣|依|月|洋|英|医|怡|弋|亿|仰|应|姚|禹|尤|云|闫|乐|宇|约|庾|苑|严|阎|羊|尹|亚|夭|游|俞|余|叶|胥|袁|雍|阳|易|岳|殷|晏|鄢|颜|喻|杨|扬|\
Z|足|翟|联|宗|査|志|支|诸|褚|谌|臧|占|卓|植|正|资|张|祖|赵|邹|章|仲|甄|詹|竹|祝|庄|左|周|朱|郑|泽|钟|扎)'

#曾经，户籍，宣告              
ss_name = '(\
火补色拉|曲木什古|麦麦提艾力·艾孜拉|瓦扎阿作|王某甲王某|萨德|西热艾力.苏勒坦|曲木么里作|\
...
邛莫挖长|邛莫广长|邛莫广州|邛莫支付|邛莫小明|邛莫根美|邛莫乡长|邛莫支也|邛莫军军|邛莫者林|甲央|\
乃古呷色|他巴降泽|伙补子且|介洛某某|尼胡底石|尼杜小兵)'
#|送|本|刀|将|时||把||起未|于
invalid_name = '(\
